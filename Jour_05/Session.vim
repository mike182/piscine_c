...
badd +0 my.h
badd +0 main.c
badd +0 my_factorielle_it.c
badd +0 my_factorielle_rec.c
badd +0 my_power_it.c
badd +0 my_power_rec.c
badd +0 my_8r1.c
badd +1 my_8r2.c
badd +0 my_square_root.c
badd +0 my_is_prime.c
badd +0 my_find_prime_sup.c
argglobal
%argdel
set stal=2
...
normal! 0
tabnext
edit my_factorielle_rec.c
argglobal
balt my_factorielle_it.c
let s:l = 1 - ((0 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
